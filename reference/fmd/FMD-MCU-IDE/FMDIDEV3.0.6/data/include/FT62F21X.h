...
// Register: TKCON
volatile unsigned char           TKCON          @ 0x086;
// bit and bitfield definitions
volatile bit TKCHE0                 @ ((unsigned)&TKCON*8)+0;
volatile bit TKCHE1                 @ ((unsigned)&TKCON*8)+1;
volatile bit TKCHE2                 @ ((unsigned)&TKCON*8)+2;
volatile bit TKCHE3                 @ ((unsigned)&TKCON*8)+3;
volatile bit TKEN                   @ ((unsigned)&TKCON*8)+4;
volatile bit TKCHGS0                @ ((unsigned)&TKCON*8)+5;
volatile bit TKCHGS1                @ ((unsigned)&TKCON*8)+6;
#ifndef _LIB_BUILD
volatile union {
    struct {
        unsigned	TKCHE               : 4;
