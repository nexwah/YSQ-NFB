...
int PowerOn,BTNpressed,BTNtimer,HTOn,HTtimer,SmokeOn,Smoketimer,PuffOn,RDE1,RDE2,t1E,t2E,T1E,T2E,PTE,PFE,T0E,TRE,R0E,BATL,WAIT = 0;
unsigned long BTNcnt,HTcnt,HTtimecnt,Smokecnt,Smoketimecnt,Puffcnt,WAITcnt = 0;
 ...
 * 输出：  无
 ...
 void IO_INT_INITIAL(void)
 {
     ...
     ITYPE0=0B00000000;			
     ITYPE1=0B00010010;			//下降沿
     EPIE0=0B01010000;			//使能中断4
