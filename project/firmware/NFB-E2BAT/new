...
char command[10],valc[10];
int n =0;
unsigned int HTVP_,HTVN_,HTVI_ = 0;
float HTVP,HTVN,HTVI,I,V,R,T,diffT,bat = 0;
int PowerOn,BTNpressed,BTNtimer,HTOn,HTtimer,SmokeOn,Smoketimer,PuffOn,RDE,t1E,t2E,T1E,T2E,PTE,PFE = 0;
unsigned long BTNcnt,HTcnt,HTtimecnt,Smokecnt,Smoketimecnt,Puffcnt,millisnow = 0;
int timeleft,timeleft1,timeleft2,timeleft3,timenow,timenowbat = 0;
...
void EEPROM_INIT(void)
{
    ...
    if(EEReadData != 0x45){          
        EEPROMwrite(0x00,0x45);		//0x45(E)写入地址0x00
